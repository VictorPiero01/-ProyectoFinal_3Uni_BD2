...
namespace SistemaVeterinaria.Principal
{
    public partial class FrmMascota : MaterialSkin.Controls.MaterialForm
    {
        ...
        private void btnGuardar_Click(object sender, EventArgs e)
        {
            ...
            var setter = client.Set("Mascota" + txtDni.Text, objEMas);
            MessageBox.Show("Mascota Agregado");
        }
        ...
        private void btnModificar_Click(object sender, EventArgs e)
        {
            ...
            var setter = client.Update("Mascota" + txtNombre.Text, objEMas);
        ...
        private void btnBuscar_Click(object sender, EventArgs e)
        {
            ...
            objEcli.Dni = datosresultado.Dni.ToString();
            objEcli.Nombre = datosresultado.Nombre.ToString();
            objEcli.Apellido = datosresultado.Apellido.ToString();
            objEcli.Email = datosresultado.Email.ToString();
            objEcli.Telefono = datosresultado.Telefono.ToString();
            objEcli.Direccion = datosresultado.Direccion.ToString();

            txtNombres.Text = datosresultado.Nombre;
            txtTelefono.Text = datosresultado.Telefono;
            txtDireccion.Text = datosresultado.Direccion;
        }
        ...
        private void btnBuscarPorDni_Click(object sender, EventArgs e)
        {
            ...
            list.Add(objEMas);
            dgvMascotas.DataSource = list;


            var result2 = client.Get("Cliente" + txtBuscar.Text);
            ClsEClientes datosresultado2 = result.ResultAs<ClsEClientes>();
            ClsEClientes objEcli = new ClsEClientes();


            txtNombres.Text = datosresultado2.Nombre;
            txtTelefono.Text = datosresultado2.Telefono;
            txtDireccion.Text = datosresultado2.Direccion;
        }
