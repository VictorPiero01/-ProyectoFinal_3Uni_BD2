...
namespace SistemaVeterinaria.Principal
{
    public partial class FrmClientes : MaterialSkin.Controls.MaterialForm
    {
        ...
        private void btnGuardar_Click(object sender, EventArgs e)
        {
            ...
            var setter = client.Set("Cliente"+txtDni.Text, objEcli);
            MessageBox.Show("Cliente Agregado");
        ...
        private void btnModificar_Click(object sender, EventArgs e)
        {
            ...
            var setter = client.Update("Cliente" + txtDni.Text, objEcli);
        ...
        private void btnEliminar_Click(object sender, EventArgs e)
        {
            ...
            var setter = client.Delete("Cliente" + txtDni.Text);
            MessageBox.Show("Datos Eliminados correctamente...");
        }
        public void listar()
        {
        ...
        private void btnBuscar_Click(object sender, EventArgs e)
        {
           /* ClsEClientes objEcli = new ClsEClientes();
            ...
            var result = client.Get("Cliente" + textBuscar.Text);
            ...
            List<ClsEClientes> list = new List<ClsEClientes>();
            list.Add(objEcli);
